 ...
 */
public class WorkManagerImpl2 implements WorkManager {
	...
	@Override
	public void setDone(final WorkList aWorkList) {
		this.doneLists.add(aWorkList);
	}

	@Override
	public boolean isDone(final WorkList aWorkList) {
