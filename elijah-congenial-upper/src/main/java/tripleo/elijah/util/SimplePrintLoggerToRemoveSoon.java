...
//		System.out.println(""+aS);
	...
	public static void print_err_015elko(final String aS) {
//		System.err.println(aS);
	}

	public static void println_err_011(final Object aS) {
		System.err.println(aS);
	}

	public static void println_out_012(final String aS) {
		System.err.println(aS);
	}

	public static void println_err_013(final String aS) {
		System.err.println(aS);
	}

	public static void println_out_014(final String aS) {
		System.err.println(aS);
	}
